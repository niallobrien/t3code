import type { DesktopSshPasswordPromptRequest } from "@agentsmith/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@agentsmith/contracts";
import type { SshPasswordRequest } from "@agentsmith/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `AgentSmith window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@agentsmith/desktop/ssh/DesktopSshPasswordPrompts") {}
