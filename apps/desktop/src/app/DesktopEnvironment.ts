...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    // Built web client the packaged renderer is served from over agentsmith://app.
    readonly clientAssetsDir: string;
    readonly backendCwd: string;
    readonly preloadPath: string;
    readonly appUpdateYmlPath: string;
    readonly devServerUrl: Option.Option<URL>;
    readonly devRemoteAgentsmithServerEntryPath: Option.Option<string>;
...
>()("@agentsmith/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "AgentSmith";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    agentsmithHome: config.agentsmithHome,
  });
  ...
  const userDataDirName = isDevelopment ? "agentsmith-dev" : "agentsmith";
  const legacyUserDataDirName = isDevelopment ? "AgentSmith (Dev)" : "AgentSmith (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteAgentsmithServerEntryPath: config.devRemoteAgentsmithServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.agentsmith.agentsmith.dev" : "com.agentsmith.agentsmith",
    ),
