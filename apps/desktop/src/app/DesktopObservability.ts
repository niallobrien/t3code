import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@agentsmith/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@agentsmith/shared/observability";
...
>()("@agentsmith/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
