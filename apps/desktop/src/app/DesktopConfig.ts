...
export const DesktopConfig = Config.all({
  ...
  desktopHttpsEndpointUrls: commaSeparatedStrings("AGENTSMITH_DESKTOP_HTTPS_ENDPOINTS"),
  otlpTracesUrl: trimmedString("AGENTSMITH_OTLP_TRACES_URL"),
  otlpExportIntervalMs: Config.int("AGENTSMITH_OTLP_EXPORT_INTERVAL_MS").pipe(
    Config.withDefault(10_000),
  ),
  appImagePath: trimmedString("APPIMAGE"),
  disableAutoUpdate: optionalBoolean("AGENTSMITH_DISABLE_AUTO_UPDATE"),
  mockUpdates: optionalBoolean("AGENTSMITH_DESKTOP_MOCK_UPDATES"),
  mockUpdateServerPort: Config.port("AGENTSMITH_DESKTOP_MOCK_UPDATE_SERVER_PORT").pipe(
