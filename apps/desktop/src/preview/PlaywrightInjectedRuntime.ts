...
export const playwrightInjectedRuntimeInstallExpression = Effect.fn(
  ...
  return `(() => {
    if (globalThis.__agentsmithPlaywrightInjected) return true;
    const module = { exports: {} };
    ${source}
    globalThis.__agentsmithPlaywrightInjected = new (module.exports.InjectedScript())(globalThis, ${options});
    return true;
  })()`;
});
