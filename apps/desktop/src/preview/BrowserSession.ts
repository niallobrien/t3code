...
const PREVIEW_PARTITION_PREFIX = "persist:agentsmith-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "agentsmith-preview-ephemeral-";
...
>()("@agentsmith/desktop/preview/BrowserSession") {}
