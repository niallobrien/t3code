...
>()("@agentsmith/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__AGENTSMITH_ENV_${name}_START__`;
const endMarker = (name: string) => `__AGENTSMITH_ENV_${name}_END__`;
