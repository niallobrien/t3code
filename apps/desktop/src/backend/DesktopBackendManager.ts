...
import { waitForHttpReady as waitForHttpReadyShared } from "@agentsmith/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/agentsmith/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // AGENTSMITH_HOME can't pin the WSL backend to /mnt/c/...\.agentsmith.
