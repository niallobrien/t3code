...
const NAME = "org.gnome.Shell.Extensions.AgentsmithSnapShot";
const PATH = "/org/gnome/Shell/Extensions/AgentsmithSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`AgentSmith capture preview unavailable: ${error.message}`);
    }
  }
...
export default class AgentsmithSnapShotExtension extends Extension {
  enable() {
