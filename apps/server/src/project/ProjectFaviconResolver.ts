...
>()("agentsmith/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* AgentsmithProjectFileLoader.AgentsmithProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A agentsmith.json iconPath takes precedence over the well-known locations.
