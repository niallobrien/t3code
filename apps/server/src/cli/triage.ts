/**
 * `agentsmith triage` - hand a misbehaving install to the user's own coding agent.
 *
...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate a AgentSmith problem on this machine with claude or codex, and help file a good issue.",
  ),
  Command.withHandler((flags) =>
    Effect.gen(function* () {
      ...
      // --base-dir wins; AGENTSMITH_HOME is its documented env equivalent (same
      // precedence as `agentsmith pair`).
