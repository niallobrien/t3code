...
import { makeKeyedCoalescingWorker } from "@agentsmith/shared/KeyedCoalescingWorker";
...
>()("agentsmith/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("AGENTSMITH_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_AgentSmith-XXXX/usr/bin, the bundled glib schemas,
