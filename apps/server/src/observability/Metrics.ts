...
export const rpcRequestsTotal = Metric.counter("agentsmith_rpc_requests_total", {
  description: "Total RPC requests handled by the websocket RPC server.",
});

export const rpcRequestDuration = Metric.timer("agentsmith_rpc_request_duration", {
...
export const orchestrationEventsProcessedTotal = Metric.counter(
  "agentsmith_orchestration_events_processed_total",
  {
    description: "Total orchestration intent events processed by runtime reactors.",
  },
);

export const providerSessionsTotal = Metric.counter("agentsmith_provider_sessions_total", {
  description: "Total provider session lifecycle operations.",
});

export const providerTurnsTotal = Metric.counter("agentsmith_provider_turns_total", {
  description: "Total provider turn lifecycle operations.",
});

export const providerTurnDuration = Metric.timer("agentsmith_provider_turn_duration", {
...
export const gitCommandDuration = Metric.timer("agentsmith_git_command_duration", {
  description: "Git command execution duration.",
});

export const terminalSessionsTotal = Metric.counter("agentsmith_terminal_sessions_total", {
  description: "Total terminal sessions started.",
});

export const terminalRestartsTotal = Metric.counter("agentsmith_terminal_restarts_total", {
