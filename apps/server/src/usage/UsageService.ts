 ...
 * Grok Build) rather than AgentSmith's orchestration projections, so usage covers
 * turns driven outside AgentSmith too. This is the approach `ccusage` takes.
 *
