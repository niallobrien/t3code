...
const connectPublicConfigMissingMessage =
  "AgentSmith Connect commands are unavailable: this build is missing AgentSmith Connect public configuration.";
  ...
  Command.withHandler(() =>
    Effect.fail(
      new CliError.ShowHelp({
        commandPath: ["agentsmith", "connect"],
...
export const makeCli = ({ cloudEnabled = hasCloudPublicConfig } = {}) =>
  Command.make("agentsmith", { ...sharedServerCommandFlags }).pipe(
    Command.withDescription("Run the AgentSmith server."),
