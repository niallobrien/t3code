...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@agentsmith/contracts";
...
const owner = "agentsmith-auth-session-owner";
const otherOwner = "agentsmith-auth-session-other";
