...
import { codexModelFamily } from "@agentsmith/shared/model";
...
const MODEL_MANIFEST_URL =
  "https://raw.githubusercontent.com/pingdotgg/agentsmith/main/apps/server/src/provider/model-manifest.json";
...
>()("agentsmith/provider/ModelManifest") {}
