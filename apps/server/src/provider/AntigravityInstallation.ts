...
import { ProviderDriverKind, type ProviderInstallState } from "@agentsmith/contracts";
import {
...
>()("agentsmith/provider/AntigravityInstallation") {
    ...
    Effect.fn("AntigravityInstallation.validate")(
      function* (executable: AntigravityExecutable, expectedVersion: string) {
        const profileDirectory = yield* fs.makeTempDirectoryScoped({
          prefix: "agentsmith-antigravity-validate-",
        });
