...
import { resolveCommandPath } from "@agentsmith/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@agentsmith/server/providerMaintenance/ProviderVersionCache",
  {
 ...
 * owns that path; anything unproven stays manual-only so AgentSmith never runs
