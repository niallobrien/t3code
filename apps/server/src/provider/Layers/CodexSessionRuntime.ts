...
import { normalizeModelSlug } from "@agentsmith/shared/model";
...
import {
  ...
  type AgentSmithToolAvailability,
...
export interface CodexSessionRuntimeOptions {
  ...
  /** Capabilities the session's `agentsmith` MCP credential grants; drives the prompt blocks. */
...
/** Converts a AgentSmith approval decision into the MCP elicitation wire response. */
...
function buildCodexCollaborationMode(input: {
  ...
  readonly browserToolsAvailable?: boolean | AgentSmithToolAvailability;
