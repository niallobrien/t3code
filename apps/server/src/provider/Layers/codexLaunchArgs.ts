import { tokenizeCliArgs } from "@agentsmith/shared/cliArgs";

const AGENTSMITH_CODEX_LAUNCH_ARGS_ENV = "AGENTSMITH_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[AGENTSMITH_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
