...
import { parseCliArgs } from "@agentsmith/shared/cliArgs";
...
} from "@agentsmith/shared/claudeCompaction";
import { HostProcessIsExecutable } from "@agentsmith/shared/hostProcess";
...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    switch (message.subtype) {
      ...
      case "model_refusal_fallback":
        ...
        return;
      // Inner protocol/UX details with no AgentSmith surface today — consumed
  ...
  const handleSdkMessage = Effect.fn("handleSdkMessage")(function* (
    ...
    // Wire-only command bookkeeping has no user-facing AgentSmith lifecycle.
    ...
    switch (message.type) {
      ...
      case "rate_limit_event":
        ...
        return;
      // Composer prompt suggestions have no AgentSmith surface; consumed deliberately.
      // `conversation_reset` announces a CLI-side conversation id swap
      // (e.g. /clear); AgentSmith keeps its own thread identity and resume cursor.
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleAskUserQuestion = Effect.fn("handleAskUserQuestion")(function* (
        ...
        // expected lookup key. See https://github.com/pingdotgg/agentsmith/issues/2388
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @agentsmith/shared/claudeCompaction because
      ...
      // A permission launch arg is folded into the mode AgentSmith sends rather than
  ...
  const rollbackThread: ClaudeAdapterShape["rollbackThread"] = Effect.fn("rollbackThread")(
    function* (threadId, numTurns) {
      ...
      // their AgentSmith turn count agrees; steers must never be treated as extra turns.
      if (
