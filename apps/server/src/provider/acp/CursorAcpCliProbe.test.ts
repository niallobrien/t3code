 ...
 * Enable with: AGENTSMITH_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.AGENTSMITH_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
    ...
    Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "agentsmith-probe", version: "0.0.0" },
