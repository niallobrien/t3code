import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@agentsmith/contracts";
...
const AGENTSMITH_OAUTH_REFERRER = "agentsmith";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: AGENTSMITH_OAUTH_REFERRER,
    },
  };
}
...
/**
 * AgentSmith's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
