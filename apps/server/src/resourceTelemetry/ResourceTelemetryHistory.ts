...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allAgentsmith.currentCpuPercent,
      rssBytes: merged.groups.allAgentsmith.currentRssBytes,
      processCount: merged.groups.allAgentsmith.processCount,
