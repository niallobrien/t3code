...
declare const __AGENTSMITH_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __AGENTSMITH_BUILD_CHANNEL__ === "undefined" ? "dev" : __AGENTSMITH_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "AgentSmith (Dev)",
  nightly: "AgentSmith (Nightly)",
  latest: "AgentSmith",
...
<html lang="en">
  <head>
    ...
    <title>AgentSmith Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up AgentSmith Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
