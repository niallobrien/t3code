import { readConnectAuthorizeRequest } from "@agentsmith/shared/connectAuth";
...
const TEST_ENV = {
  AGENTSMITH_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  AGENTSMITH_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  AGENTSMITH_HOSTED_APP_URL: "https://hosted.example.test",
};
