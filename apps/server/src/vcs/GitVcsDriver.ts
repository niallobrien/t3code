  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `agentsmith-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "AgentSmith",
        GIT_AUTHOR_EMAIL: "agentsmith@users.noreply.github.com",
        GIT_COMMITTER_NAME: "AgentSmith",
        GIT_COMMITTER_EMAIL: "agentsmith@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `agentsmith checkpoint ref=${input.checkpointRef}`;
