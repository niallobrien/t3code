...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@agentsmith/contracts";
import { VcsUnsupportedOperationError } from "@agentsmith/contracts";
...
>()("agentsmith/vcs/VcsDriverRegistry") {}
