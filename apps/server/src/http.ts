...
import { isDevProxiedPath } from "@agentsmith/shared/devProxy";
import { decodeOtlpTraceRecords } from "@agentsmith/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["agentsmith://app", "agentsmith-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // AGENTSMITH_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
