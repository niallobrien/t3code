...
describe("rewriteMarkdownFileUriHref", () => {
  ...
  it("normalizes file uri hrefs for windows drive paths", () => {
    expect(
      rewriteMarkdownFileUriHref(
        "file:///D:/Programme/agentsmith/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/agentsmith/apps/web/src/components/chat/OpenInPicker.tsx#L69");
  });
...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("formats tooltip display paths relative to the cwd when possible", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "file:///C:/Users/mike/dev-stuff/agentsmith/apps/web/src/session-logic.ts#L501",
        "C:/Users/mike/dev-stuff/agentsmith",
      ),
    ).toMatchObject({
      displayPath: "agentsmith/apps/web/src/session-logic.ts:501",
  ...
  it("formats tooltip display paths relative to the cwd for slash-prefixed windows paths", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/C:/Users/mike/dev-stuff/agentsmith/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
        "C:/Users/mike/dev-stuff/agentsmith",
      ),
    ).toMatchObject({
      displayPath:
        "agentsmith/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
  ...
  it("does not classify a case-distinct POSIX sibling as a workspace file", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/tmp/agentsmith-case-test/project/probe.txt",
        "/tmp/agentsmith-case-test/Project",
      ),
    ).toMatchObject({
      displayPath: "/tmp/agentsmith-case-test/project/probe.txt",
      workspaceRelativePath: null,
    });
  });
  ...
  it("normalizes slash-prefixed windows drive paths before resolving", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "/D:/Programme/agentsmith/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/agentsmith/apps/web/src/components/chat/OpenInPicker.tsx:69");
  });

  it("resolves angle-bracketed windows drive paths", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "</D:/Programme/agentsmith/apps/web/src/components/ChatMarkdown.tsx:1>",
      ),
    ).toBe("D:/Programme/agentsmith/apps/web/src/components/ChatMarkdown.tsx:1");
  });
