import { scopedThreadKey } from "@agentsmith/client-runtime/environment";
import type { ScopedThreadRef, TurnId } from "@agentsmith/contracts";
...
export const useDiffPanelStore = create<DiffPanelStoreState>()(
  persist(
    ...
    {
      name: "agentsmith:diff-panel-state:v1",
      version: 1,
