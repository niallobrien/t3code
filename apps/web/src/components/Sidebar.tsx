...
import type { EnvironmentThreadShell } from "@agentsmith/client-runtime/state/models";
import {
...
const SETTLED_SHELF_EXPANDED_KEY = "agentsmith:sidebar:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "agentsmith:sidebar:snoozed-expanded";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // Plain clicks open AgentSmith; individual PR links also support opening the host in a new tab.
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (AgentSmith Connect, hosted) resolve their
