...
const NO_FILE_SCRIPTS: ReadonlyArray<AgentsmithProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in agentsmith.json, offered for import. */
  fileScripts?: ReadonlyArray<AgentsmithProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: AgentsmithProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From agentsmith.json</MenuGroupLabel>
