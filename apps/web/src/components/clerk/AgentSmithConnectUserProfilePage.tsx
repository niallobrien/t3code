...
export function AgentSmithConnectEnvironmentRow(props: {
...
export function AgentSmithConnectUserProfilePage() {
  ...
  const handleDeregister = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      ...
      toastManager.add({
        ...
        description: "AgentSmith Connect access was revoked and a host space is now available.",
      });
      return;
    }
    ...
    console.error("[agentsmith-connect] Could not deregister environment", {
      environmentId: environment.environmentId,
      message,
      traceId,
      cause,
        ...
        {isInitialLoad ? (
          ...
          <ul className="border-t">
            {environments.map((environment) => (
              <AgentSmithConnectEnvironmentRow
