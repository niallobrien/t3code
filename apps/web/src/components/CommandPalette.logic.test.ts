...
import { EnvironmentId, ProjectId, ProviderInstanceId, ThreadId } from "@agentsmith/contracts";
...
describe("buildCommandPaletteProjectMetadata", () => {
  ...
  it("makes every member environment and path searchable", () => {
      ...
      projects: [
        {
          ...
          title: "AgentSmith",
          workspaceRoot: "/Users/theo/Projects/agentsmith",
        },
        {
          environmentId: remoteEnvironmentId,
          title: "agentsmith",
          workspaceRoot: "/srv/agentsmith",
        },
      ],
    ...
    expect(metadata.searchTerms).toEqual([
      "AgentSmith",
      "/Users/theo/Projects/agentsmith",
      "Local",
      "agentsmith",
      "/srv/agentsmith",
      "Build box",
    ...
    const metadata = buildCommandPaletteProjectMetadata({
      projects: [
        ...
        },
        {
          ...
          workspaceRoot: "/srv/agentsmith-feature",
        },
      ],
      locationByEnvironmentId: locations,
    });
    ...
    const metadata = buildCommandPaletteProjectMetadata({
      projects: [
        ...
        },
        {
          ...
          title: "AgentSmith mirror",
          workspaceRoot: "/srv/mirror/agentsmith",
        },
      ],
...
describe("buildProjectActionItems", () => {
  it("shows the grouped display name but keeps the real title for icons", () => {
    ...
    const [item] = buildProjectActionItems({
      projects: [{ ...project, displayName: "agentsmithdotgg/fleet" }],
      valuePrefix: "project",
      icon: (candidate) => {
    ...
    expect(item?.title).toBe("agentsmithdotgg/fleet");
    expect(item?.searchTerms).toEqual(
      expect.arrayContaining(["agentsmithdotgg/fleet", "fleet", "/Users/theo/Code/p/fleet"]),
    );
...
describe("buildThreadActionItems", () => {
  ...
  it("keeps message excerpts searchable without replacing thread metadata", () => {
    const [item] = buildThreadActionItems({
      ...
      projectTitleById: new Map([[PROJECT_ID, "AgentSmith"]]),
      sortOrder: "updated_at",
      icon: null,
      getContentMatch: () => ({
        source: "assistant",
    ...
    expect(item?.description).toBe("AgentSmith · #feat/search");
  });
  ...
  it("prefers renderDescription when provided", () => {
    ...
    expect(item?.description).toBe("AgentSmith:feat/search:wt");
  });
...
it.each([
  "#10839",
  "10839",
  "pingdotgg/agentsmith#10839",
  "https://github.com/pingdotgg/agentsmith/pull/10839",
        ...
        pullRequests: [
          {
            ...
            number: 10839,
            url: "https://github.com/pingdotgg/agentsmith/pull/10839",
            source: "manual",
