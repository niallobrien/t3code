...
describe("MessagesTimeline", () => {
  ...
  it("anchors the first user message using its measured height", () => {
    ...
    expect(markup).toContain("agentsmith — Tests");
  ...
  it("does not render window details before the preview URL resolves", () => {
    ...
    expect(markup).not.toContain("agentsmith — Tests");
  ...
  it("renders unsafe user HTML as inert source text", async () => {
    ...
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        ...
        timelineEntries={[
          buildUserTimelineEntry(
            '<script>globalThis.__agentsmithXss = 1</script><img src="x" onerror="globalThis.__agentsmithXss = 2">',
          ),
        ]}
      />,
    );

    expect(markup).toContain("&lt;script&gt;globalThis.__agentsmithXss = 1&lt;/script&gt;");
    expect(markup).toContain(
      "&lt;img src=&quot;x&quot; onerror=&quot;globalThis.__agentsmithXss = 2&quot;&gt;",
    );
  ...
  it("sanitizes executable HTML while preserving supported assistant markup", async () => {
      ...
      <MessagesTimeline
        ...
        timelineEntries={[
          buildAssistantTimelineEntry(
            [
              '<details open onclick="globalThis.__agentsmithXss = 1">',
              "<summary>Safe details</summary>",
              "<script>globalThis.__agentsmithXss = 2</script>",
              '<img src="x" onerror="globalThis.__agentsmithXss = 3">',
              '<a href="javascript:globalThis.__agentsmithXss = 4">Unsafe link</a>',
              "</details>",
            ].join(""),
          ),
        ]}
    ...
    expect(markup).not.toContain("globalThis.__agentsmithXss");
  });
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/agentsmith/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/agentsmith"
      />,
    );
  ...
  it("renders attachment chips bound to server ids and hides their file rows", () => {
        ...
        timelineEntries={[
          {
            ...
            message: {
              ...
              role: "user",
              text: "See ![shot.png](agentsmith-context://v1/image/img-1) and [notes.txt](agentsmith-context://v1/file/file-1).",
              attachments: [
                {
                  type: "image",
                  id: "thread-1-aaa",
    ...
    expect(markup).not.toContain('href="agentsmith-context://');
        ...
        timelineEntries={[
          {
            ...
            message: {
              ...
              role: "user",
              text: "Compare [Terminal 1 line 4](agentsmith-context://v1/terminal/ctx-t) with [gone](agentsmith-context://v1/future/ctx-x).",
              context: {
                version: 1,
                records: [
                  {
