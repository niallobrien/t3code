...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@agentsmith/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "agentsmith-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("agentsmith-assistant-citation") === highlighted) {
      CSS.highlights.delete("agentsmith-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("agentsmith-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "agentsmith-assistant-citation-pulse";
