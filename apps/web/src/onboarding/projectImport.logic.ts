import { findProjectByPath } from "@agentsmith/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@agentsmith/contracts";
