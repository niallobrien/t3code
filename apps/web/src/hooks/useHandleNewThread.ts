...
import { DEFAULT_SERVER_SETTINGS, type ScopedProjectRef, type ThreadId } from "@agentsmith/contracts";
...
import { resolveDefaultThreadEnvMode } from "@agentsmith/shared/threadEnvMode";
...
import { readAgentsmithProjectFileDefaultThreadEnvMode } from "../lib/agentsmithProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The agentsmith.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readAgentsmithProjectFileDefaultThreadEnvMode(
