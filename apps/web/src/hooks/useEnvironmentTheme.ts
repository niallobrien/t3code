import type { EnvironmentTheme } from "@agentsmith/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent AgentSmith palette rather than a foreign
 ...
 * than rendered: a published `agentsmith-iris.json` would show this palette on its
