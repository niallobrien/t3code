...
import { parseScopedThreadKey, scopedThreadKey } from "@agentsmith/client-runtime/environment";
...
const TERMINAL_UI_STATE_STORAGE_KEY = "agentsmith:terminal-state:v1";
