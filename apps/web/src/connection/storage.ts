import {
  ...
  replaceCatalogValue,
} from "@agentsmith/client-runtime/platform";
import { TokenStore } from "@agentsmith/client-runtime/authorization";
import {
...
const DATABASE_NAME = "agentsmith:connection-runtime";
...
const GITHUB_ROUTING_KEY_PREFIX = "agentsmith:github-routing:";
const GITHUB_ROUTING_CHANGED = "agentsmith:github-routing-changed";
