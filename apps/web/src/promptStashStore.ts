import { ComposerContextRecord, ForwardCompatibleArray } from "@agentsmith/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "agentsmith:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "agentsmith:prompt-stash:v1";
