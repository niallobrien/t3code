...
import type { PullRequestMergeMethod } from "@agentsmith/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "agentsmith:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "agentsmith:renderer-state:v8",
  "agentsmith:renderer-state:v7",
  "agentsmith:renderer-state:v6",
  "agentsmith:renderer-state:v5",
  "agentsmith:renderer-state:v4",
  "agentsmith:renderer-state:v3",
