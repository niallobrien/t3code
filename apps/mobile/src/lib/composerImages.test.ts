...
describe("native pasted image cleanup", () => {
  ...
  it("recognizes only files created in the native composer paste directory", () => {
    expect(
      isOwnedPastedImageUri(
        "file:///private/var/mobile/Containers/Data/Application/app/tmp/agentsmith-composer-paste/id.png",
      ),
    ).toBe(true);
  ...
  it("deletes rejected and overflow owned files without deleting user-owned files", async () => {
    const rejected =
      "file:///private/var/mobile/Containers/Data/Application/app/tmp/agentsmith-composer-paste/bad.png";
    const overflow =
      "file:///private/var/mobile/Containers/Data/Application/app/tmp/agentsmith-composer-paste/overflow.png";
  ...
  it("persists folded text unchanged in the app-owned attachment directory", async () => {
    ...
    expect(attachment).toEqual({
      ...
      fileUri: "file:///documents/agentsmith-composer-attachments/attachment-id-pasted-text.txt",
