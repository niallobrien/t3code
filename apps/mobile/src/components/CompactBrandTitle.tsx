...
export function CompactBrandTitle(
  ...
  return (
    <View
      aria-level={1}
      accessibilityLabel="AgentSmith, Threads"
      accessible
      role="heading"
    ...
    >
      ...
      <Text
        ...
        className="font-agentsmith-medium text-[21px] tracking-[-0.5px] text-foreground-muted"
      >
        AgentSmith
      </Text>
      <View className="rounded-full bg-subtle px-1.5 py-0.5">
        <Text
          allowFontScaling={props.allowFontScaling}
          className="font-agentsmith-bold text-[9px] tracking-[0.9px] text-foreground-muted uppercase"
        >
          {stageLabel}
        </Text>
      </View>
