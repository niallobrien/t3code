...
const PREFERENCES_KEY = "agentsmith.preferences";
const PREFERENCES_FALLBACK_KEY = "agentsmith.preferences.fallback";
...
>()("@agentsmith/mobile/persistence/MobilePreferencesStore") {}
