...
const CONNECTIONS_KEY = "agentsmith.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "agentsmith.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "agentsmith.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "agentsmith.recent-thread-shortcuts";
...
>()("@agentsmith/mobile/persistence/MobileStorage") {}
