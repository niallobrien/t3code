...
import { EnvironmentProject, EnvironmentThreadShell } from "@agentsmith/client-runtime/state/shell";
...
import type { GitRunStackedActionResult } from "@agentsmith/contracts";
import {
