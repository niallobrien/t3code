...
import { EnvironmentNotRegisteredError } from "@agentsmith/client-runtime/connection";
import { isTransportConnectionErrorMessage } from "@agentsmith/client-runtime/errors";
import { EnvironmentRpcUnavailableError } from "@agentsmith/client-runtime/rpc";
import {
  CommandId,
  ComposerContextId,
...
describe("thread outbox", () => {
  it("retains structured context through a persisted offline queue round trip", () => {
    const message: QueuedThreadMessage = {
      ...
      text: "[Build](agentsmith-context://v1/terminal/build-output)",
      context: {
        version: 1,
        records: [
          {
