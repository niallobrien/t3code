...
import { ConnectionTransientError } from "@agentsmith/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "agentsmith.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "agentsmith.connections";
