...
import { mixThemePreviewBase, THEME_PREVIEW_RENDER_SPECS } from "@agentsmith/shared/themePreview";
...
function ThemeCard(props: {
  ...
  return (
    <View className="min-w-36 flex-1 basis-[47%] gap-3 rounded-[24px] border border-border bg-card px-2 py-4">
      ...
      <Text
        className="min-w-0 flex-1 px-1 text-lg font-agentsmith-medium"
        numberOfLines={1}
        pointerEvents="none"
      >
        {props.label}
  ...
  return (
    ...
    >
      ...
      <Text
        className={
          props.selected
            ? "text-center text-base font-agentsmith-bold text-foreground"
