...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@agentsmith/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-agentsmith-medium tabular-nums text-danger-foreground" numberOfLines={1}>
