...
import { AgentsmithKeyboardCommands } from "../../native/AgentsmithKeyboardCommands";
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <>
      <AgentsmithKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
        {children}
