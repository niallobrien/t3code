...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.agentsmith.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.agentsmith.sh",
  wsBaseUrl: "wss://pocket-pi.agentsmith.sh",
  providerKind: "agentsmith_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.agentsmith.sh",
    isRelayManaged: true,
    isEnabled: true,
