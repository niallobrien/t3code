...
import type { EnvironmentId, ToolActivityIcon } from "@agentsmith/contracts";
import { toolActivityFaviconUrl } from "@agentsmith/shared/favicon";

import { AppText as Text } from "../../components/AppText";
import { AgentsmithWordmark } from "../../components/AgentsmithWordmark";
...
type WorkContentIcon = AppSymbolName | "browser" | "device" | "agentsmith" | "pull-request";
      ...
      >
        <View className="min-h-8 flex-row items-center gap-1.5">
            ...
            <>
              ...
              <Text
                className={cn(
                  ...
                  iconIsDestructive && "font-agentsmith-medium text-adaptive-rose-600-400",
                )}
          ...
          <View className="shrink-0 flex-row items-center gap-px">
            {props.copied ? (
              <Text className="pr-1 font-agentsmith-medium text-3xs text-adaptive-emerald-600-400">
                Copied
              </Text>
            ) : null}
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly summaryToolIcon?: "browser" | "device" | "agentsmith" | "pull-request";
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@agentsmith/contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
      ...
      >
        <View className="flex-row items-center gap-2">
          ...
          <View className="min-w-0 flex-1 gap-0.5">
            <Text
              key={props.rowSizing.textSizeKey}
              className="font-agentsmith-medium text-sm text-foreground"
              numberOfLines={1}
            >
              {summary.title}
            </Text>
