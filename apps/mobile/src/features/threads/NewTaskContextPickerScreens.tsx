  ...
  return (
    ...
    >
      ...
      <View className="min-w-0 flex-1 gap-0.5">
        <Text className="text-base font-agentsmith-medium text-foreground" numberOfLines={1}>
          {props.title}
        </Text>
        {props.subtitle ? (
      ...
      >
        ...
        >
          ...
          {!flow.branchesLoading && flow.branchesError ? (
            ...
            >
              <Text className="text-sm font-agentsmith-medium text-foreground">Try again</Text>
            </Pressable>
          ) : null}
        </View>
      </ScrollView>
