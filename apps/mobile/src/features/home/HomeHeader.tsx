...
import type { EnvironmentId, SidebarThreadSortOrder } from "@agentsmith/contracts";
            ...
            <WorkspaceConnectionTitle
              ...
              brand={
                <View className="flex-row items-center gap-2">
                  {/* Mirrors the desktop SidebarBrand: AgentSmith mark + muted "AgentSmith". */}
                  <AgentsmithWordmark colorClassName="accent-icon" height={22} />
                  <RNText className="-ml-0.5 text-[21px] font-agentsmith-medium tracking-[-0.5px] text-foreground-muted">
                    AgentSmith
                  </RNText>
                  <View className="rounded-full bg-subtle px-2 py-0.75">
                    <RNText className="text-[11px] font-agentsmith-bold tracking-[1.1px] text-foreground-muted uppercase">
                      {stageLabel}
                    </RNText>
                  </View>
                </View>
