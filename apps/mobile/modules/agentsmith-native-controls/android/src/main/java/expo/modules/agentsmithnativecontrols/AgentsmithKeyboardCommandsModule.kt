package expo.modules.agentsmithnativecontrols
...
class AgentsmithKeyboardCommandsModule : Module() {
  override fun definition() = ModuleDefinition {
    Name("AgentsmithKeyboardCommands")

    View(AgentsmithKeyboardCommandsView::class) {
      Prop("enabledCommands") { view: AgentsmithKeyboardCommandsView, commands: List<String> ->
...
class AgentsmithKeyboardCommandsView(
  context: Context,
