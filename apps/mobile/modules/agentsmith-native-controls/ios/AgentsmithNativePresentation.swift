...
final class AgentsmithPresentationSources {
  private class Entry {
...
final class AgentsmithPresentationSourceView: ExpoView {
  weak var sources: AgentsmithPresentationSources?
  var identifier = "" {
    didSet {
...
final class AgentsmithContextSheetSizeView: ExpoView {
  ...
  private func updateSheet() {
    ...
    while let current = responder {
      if let controller = current as? UIViewController,
        ...
        let identifier = UISheetPresentationController.Detent.Identifier("agentsmith-context-content")
