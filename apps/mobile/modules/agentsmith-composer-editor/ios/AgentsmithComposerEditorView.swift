...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "agentsmith-composer-paste"
  ...
  override func paste(_ sender: Any?) {
    ...
    let pasteboard = UIPasteboard.general
    let context = AgentsmithComposerClipboard.read()
    if !context["fragment", default: ""].isEmpty || context["html", default: ""].contains("data-agentsmith-context-fragment=") {
  ...
  override func copy(_ sender: Any?) {
    ...
    AgentsmithComposerClipboard.write(text: serializedText(in: selectedRange), fragment: clipboardFragment)
  }
...
public final class AgentsmithComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate, UIGestureRecognizerDelegate {
  ...
  private func renderChip(
    ...
    // Kept in step with `AgentsmithContextChipVectorIcon` in the markdown module: a chip drawn here and
