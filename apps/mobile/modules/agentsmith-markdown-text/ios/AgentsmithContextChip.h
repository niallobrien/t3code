...
static NSDictionary *AgentsmithContextChipPayload(NSString *uri)
{
...
static UIColor *AgentsmithContextChipColor(NSString *hex)
{
  unsigned int rgb = 0;
...
static UIColor *AgentsmithContextChipBlend(UIColor *accent, UIColor *base, CGFloat weight)
{
...
static UIImage *AgentsmithContextChipVectorIcon(NSString *symbol, CGFloat size, UIColor *color)
{
...
static inline CGRect AgentsmithContextChipBounds(UIFont *font, CGSize size)
{
...
static inline NSAttributedString *AgentsmithMarkdownTextAttachmentString(
...
static UIFont *AgentsmithContextChipFont(NSDictionary *payload)
{
...
static inline CGSize AgentsmithContextChipSize(NSDictionary *payload, CGFloat maximumWidth)
{
  UIFont *font = AgentsmithContextChipFont(payload);
...
static inline UIImage *AgentsmithContextChipImage(NSDictionary *payload, CGSize size, UIImage *fileIcon)
{
  ...
  UIColor *accent = AgentsmithContextChipColor(payload[@"accent"]);
  UIColor *foreground = AgentsmithContextChipBlend(accent, AgentsmithContextChipColor(payload[@"foreground"]), 0.22);
  UIColor *border = AgentsmithContextChipBlend(accent, AgentsmithContextChipColor(payload[@"border"]), 0.34);
  ...
  UIImage *image = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
    ...
    UIImage *icon = fileIcon
        ?: AgentsmithContextChipVectorIcon(payload[@"symbol"], iconSize, foreground)
