package expo.modules.agentsmithmarkdowntext
...
private fun contextClipData(selectedText: String, fragment: String): ClipData {
  ...
  return ClipData.newHtmlText(
    null,
    selectedText,
    "<pre data-agentsmith-context-fragment=\"$attribute\">$escaped</pre>"
  )
}
...
class AgentsmithMarkdownTextSelectionModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    Name("AgentsmithMarkdownTextSelection")
    ...
    Function("renderContextChip") { payloadJson: String ->
      ...
      val chip = AgentsmithContextChip(
        ...
        colors = AgentsmithContextChip.Colors(
          accent = AgentsmithContextChip.color(payload.optString("accent"), Color.GRAY),
          foreground = AgentsmithContextChip.color(payload.optString("foreground"), Color.BLACK),
          border = AgentsmithContextChip.color(payload.optString("border"), Color.GRAY)
        ),
