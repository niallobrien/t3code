...
import AgentsmithMarkdownTextRunNativeComponent from "./AgentsmithMarkdownTextRunNativeComponent";
import AgentsmithMarkdownTextNativeComponent from "./AgentsmithMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <AgentsmithMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <AgentsmithMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
