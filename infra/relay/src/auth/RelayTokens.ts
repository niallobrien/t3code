...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@agentsmith/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "agentsmith-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "agentsmith-relay-dpop-access+jwt";
...
>()("agentsmith-relay/auth/RelayTokens") {}
