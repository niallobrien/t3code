...
This directory maintains the [`agentsmith-bin`](https://aur.archlinux.org/packages/agentsmith-bin) and
[`agentsmith-nightly-bin`](https://aur.archlinux.org/packages/agentsmith-nightly-bin) packages. Both
