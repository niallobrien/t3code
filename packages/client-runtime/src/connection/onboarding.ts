import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@agentsmith/contracts";
import { resolveRemotePairingTarget } from "@agentsmith/shared/remote";
...
>()("@agentsmith/client-runtime/connection/onboarding/ConnectionOnboarding") {}
