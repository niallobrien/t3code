...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/agentsmith/OpenInPicker.tsx#L69",
      "D:/Programme/agentsmith/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/agentsmith/OpenInPicker.tsx", "D:/Programme/agentsmith/OpenInPicker.tsx"],
    ["</D:/Programme/agentsmith/ChatMarkdown.tsx:1>", "D:/Programme/agentsmith/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\agentsmith\\apps\\web\\a.ts", "C:/Users/mike/agentsmith", "apps/web/a.ts"],
    ["/C:/Users/mike/agentsmith/apps/web/a.ts", "C:/Users/mike/agentsmith", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/agentsmith/main.ts", "c:/users/MIKE/agentsmith", "main.ts"],
    ["/C:/USERS/mike/agentsmith/main.ts", "/c:/users/MIKE/agentsmith", "main.ts"],
