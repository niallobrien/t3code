import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@agentsmith/contracts";
...
}>("@agentsmith/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@agentsmith/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
