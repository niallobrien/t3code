...
describe("isTransportConnectionErrorMessage", () => {
  ...
  it("returns true for the AgentSmith server WebSocket message", () => {
    expect(isTransportConnectionErrorMessage("Unable to connect to the AgentSmith server WebSocket.")).toBe(
      true,
    );
  });
