...
import { AgentsmithProjectFile } from "./agentsmithProjectFile.ts";

const decode = Schema.decodeUnknownSync(AgentsmithProjectFile);

describe("AgentsmithProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://agentsmith.dev/schema/agentsmith.json",
