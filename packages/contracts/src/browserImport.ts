 ...
 * machine into a AgentSmith browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** AgentSmith profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give AgentSmith Full Disk Access in System Settings → Privacy & Security, then retry.",
