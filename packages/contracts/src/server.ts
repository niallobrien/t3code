...
/**
 * A palette the environment's machine publishes for AgentSmith to follow, read
 ...
 * over as a coherent AgentSmith palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `agentsmith` package to install (never a dist-tag, so
