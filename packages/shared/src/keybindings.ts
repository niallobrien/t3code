...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+alt+a", command: "rightPanel.addSurface", when: "previewFocus" },
  { key: "mod+alt+[", command: "rightPanel.previousSurface", when: "previewFocus" },
  { key: "mod+alt+]", command: "rightPanel.nextSurface", when: "previewFocus" },
  ...
  { key: "mod+shift+e", command: "projectScope.toggle", when: "!terminalFocus" },
