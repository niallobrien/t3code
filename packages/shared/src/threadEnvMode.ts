import type { ThreadEnvMode } from "@agentsmith/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in agentsmith.json > global server setting.
 *
 ...
 * source that outranks agentsmith.json decided, or the file read settled. While
