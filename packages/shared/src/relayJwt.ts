...
export const RELAY_LINK_PROOF_TYP = "agentsmith-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "agentsmith-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "agentsmith-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "agentsmith-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "agentsmith-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "agentsmith-env-activity+jwt";
