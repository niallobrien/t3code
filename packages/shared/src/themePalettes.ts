export const BUILT_IN_THEME_IDS = ["agentsmith-chat", "grove", "ocean", "ember", "iris"] as const;

/** The mobile app's own hand-tuned palette, which is not part of the built-in library. */
export const MOBILE_DEFAULT_THEME_ID = "agentsmith";
...
export const AGENTSMITH_CHAT_THEME: ThemeDefinition = {
  id: "agentsmith-chat",
  label: "AgentSmith Chat",
  appearance: "light",
  colors: {
