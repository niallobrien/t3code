...
const rule = createOxlintRuleHarness("agentsmith/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("agentsmith/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("agentsmith/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("agentsmith/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("agentsmith/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
