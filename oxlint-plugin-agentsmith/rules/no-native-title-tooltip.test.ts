...
const rule = createOxlintRuleHarness("agentsmith/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("agentsmith/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · AgentSmith";`);
