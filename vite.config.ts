...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-agentsmith/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "@agentsmith/client-runtime",
              message:
                "Import from an explicit @agentsmith/client-runtime/* subpath. The package has no root export.",
            },
            {
      ...
      "agentsmith/no-global-process-runtime": "error",
      "agentsmith/no-inline-schema-compile": "warn",
      "agentsmith/no-manual-effect-runtime-in-tests": "error",
      "agentsmith/no-native-title-tooltip": "error",
      "agentsmith/namespace-node-imports": "error",
    },
    overrides: [
      {
        // The one place that reads the host platform to seed the injected references.
        files: ["packages/shared/src/hostProcess.ts"],
        rules: { "agentsmith/no-global-process-runtime": "off" },
      },
      {
        files: ["apps/mobile/src/**"],
        rules: { "agentsmith/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        rules: { "agentsmith/no-hermes-unsupported-array-methods": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/AgentsmithComposerEditor.ios.tsx",
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "agentsmith/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
