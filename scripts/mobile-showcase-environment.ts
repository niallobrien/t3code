// @effect-diagnostics nodeBuiltinImport:off globalTimers:off globalDate:off - This host-side fixture creates an isolated local AgentSmith environment.
...
export const SHOWCASE_PROJECT_ID = "agentsmith";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36magentsmith\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1magentsmith\u001b[0m \u001b[2m— ~/Code/agentsmith\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  agentsmith: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <rect width="128" height="128" rx="10" fill="#000"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M91.27 62.252V68.565L65.937 93.817H59.603L34.27 68.565V62.252L59.603 37H65.937L91.27 62.252ZM62.77 80.231C70.981 80.231 77.639 73.595 77.639 65.41C77.639 57.224 70.981 50.588 62.77 50.588C54.558 50.588 47.901 57.224 47.901 65.41C47.901 73.595 54.558 80.231 62.77 80.231Z" fill="#fff"/>
</svg>`,
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    repositoryUrl: "https://github.com/pingdotgg/agentsmith.git",
    favicon: PROJECT_FAVICONS.agentsmith,
  },
  {
    id: "react",
    title: "React",
...
async function seedAgentSmithWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "agentsmith", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.agentsmith);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the AgentSmith mobile screenshot harness.\n`,
  );
  await initializeRepository({
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedAgentSmithWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
