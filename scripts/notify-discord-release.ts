  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new AgentSmith prerelease is available for nightly testers."
          : "A new AgentSmith latest release is available.",
...
).pipe(Command.withDescription("Post a AgentSmith release announcement to Discord."));
